...
<img onClick={window.scrollTo(0,0)} src={props.img} className="card-img-top img-fluid " alt="Error loading" style={{"width":"100%","height":"400px","objectFit":"cover","borderRadius":"0" }}/>
                    </Link>
